...
<!-- Page Heading -->
<div style="margin-top:2em" class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $skills_count; ?></div>
          </div>
          <div class="col-auto">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $messages_count ?></div>
          </div>
          <div class="col-auto">
